  ...
  return (
    <section className="overflow-hidden border-y border-[#EDE6DD] bg-[#FCFBF8] px-4 py-6 sm:px-6 md:py-6">
      <div className="mx-auto max-w-7xl text-center">
        ...
        <h2 className="mt-2 font-serif text-2xl font-semibold text-[#17202A] sm:text-3xl">
        ...
        <div className="flex w-max animate-testimonial-marquee gap-6 hover:[animation-play-state:paused]">
          {marqueeItems.map((partner, index) => (
            ...
            >
              ...
              <span className="font-semibold text-[#5C6570] tracking-wide text-[15px] group-hover:text-[#17202A] transition-colors">{partner}</span>
            </div>
          ))}
        </div>
      </div>
