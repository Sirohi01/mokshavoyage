    ...
    <main className="min-h-screen bg-canvas">
      <div className="border-b border-line bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.18em] text-gold">Moksha Voyage Admin</p>
            <h1 className="font-serif text-3xl font-semibold">Operations command center</h1>
          </div>
        ...
        <section className="mt-5 grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-lg border border-line bg-white p-5">
            <div className="mb-4 flex items-center justify-between">
              ...
              <span className="rounded-full border border-line px-3 py-1 text-xs font-semibold text-ocean">CMS driven</span>
            </div>
              ...
              {adminModules.map((module) => {
                ...
                return (
                  <article key={module.title} className="grid gap-3 rounded-md border border-line bg-canvas p-4 sm:grid-cols-[40px_1fr_auto]">
                    ...
                    <span className="text-sm font-semibold text-gold">{module.count}</span>
                  </article>
                );
              })}
            </div>
